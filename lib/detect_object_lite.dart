...
//
//     // Create a Float32List to hold the normalized values
//     var convertedBytes = Float32List(1 * inputSize * inputSize * 3);
//     // Create a view to treat the underlying buffer as Float32
...
//         // getPixel(x, y) returns a Pixel object
//         final pixel = image.getPixel(j, i);
//
//         // Access channels directly via .r, .g, and .b properties
//         // These replace the deprecated getRed(pixel) calls
...
//     }
//
//     // Return the buffer as a Uint8List for TFLite/model consumption
//     return convertedBytes.buffer.asUint8List();
//   }
//
//   Uint8List imageToByteListUint8(img.Image image, int inputSize) {
//     // Create a Uint8List to hold the raw RGB values
...
//     for (var i = 0; i < inputSize; i++) {
//       for (var j = 0; j < inputSize; j++) {
//         // getPixel returns a Pixel object in the new API
//         final pixel = image.getPixel(j, i);
//
//         // Access properties directly. .r, .g, and .b return
//         // the channel values as integers.
